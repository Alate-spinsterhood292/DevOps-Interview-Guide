...
4) Can we separate disk space in an EC2 instance and run the application on one partition and the observability stack on another?
5) How do you perform this disk separation, and which AWS services/tools do you use?
